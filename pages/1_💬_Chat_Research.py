...
# ------------------------------------
# 🎨 COMPLETELY FIXED STYLES - MINIMAL AND ROBUST
# ------------------------------------
st.markdown("""
<style>
/* Import Modern Font */
...
/* Simple animated background - NO OVERLAY */
.main {
...
/* REMOVE problematic ::before overlay completely */
...
/* CRITICAL: Force all chat messages to be visible */
.stChatMessage {
...
/* Force text visibility - MOST IMPORTANT */
.stChatMessage * {
...
/* Inline code should not have pre styling */
...
section[data-testid="stSidebar"] {
    background: linear-gradient(180deg, rgba(10, 14, 26, 0.95), rgba(26, 31, 58, 0.95));
...
if len(st.session_state.messages) == 0:
    st.markdown("""
    <div style="text-align: center; padding: 3rem 2rem; background: rgba(102, 126, 234, 0.1); 
